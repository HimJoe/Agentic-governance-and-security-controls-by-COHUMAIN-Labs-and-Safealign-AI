...
[![Standard](https://img.shields.io/badge/standard-v1.0.0-1F7DF0?style=flat-square)](./Agentic-Governance-and-Security-Controls-v1.0.xlsx)
...
[**🌐 Website**](https://himjoe.github.io/Agentic-governance-and-security-controls-by-COHUMAIN-Labs-and-Safealign-AI/) · [**⬇ Download the standard (.xlsx)**](./Agentic-Governance-and-Security-Controls-v1.0.xlsx) · [**📖 Full control catalog**](./controls/CONTROLS.md) · [**🤝 Contribute**](./CONTRIBUTING.md)
...
> **The key insight:** autonomous, multi-step, AI-directed killchain orchestration **has no MITRE ATT&amp;CK ID yet.** That taxonomy gap is precisely the agentic risk this standard governs. Full mapping in the [`6. ATT&amp;CK Navigator Map`](./Agentic-Governance-and-Security-Controls-v1.0.xlsx) tab and [`frameworks/mitre-attack.md`](./frameworks/mitre-attack.md).
...
├── Agentic-Governance-and-Security-Controls-v1.0.xlsx   ← the full standard (14 tabs)
├── LICENSE                                     ← CC BY 4.0
